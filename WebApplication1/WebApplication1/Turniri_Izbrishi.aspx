<%@ Page Title="Избриши Турнир" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Turniri_Izbrishi.aspx.cs" Inherits="WebApplication1.Turniri_Izbrishi" %>
            ...
            <table class="style1">
                ...
                <tr>
                    <td class="style6">
                        &nbsp;</td>
                    <td align="center">
                        Тука избришете ги податоците за Турнири</td>
                </tr>
                <tr>
                    <td class="style6">
                        &nbsp;</td>
                ...
                <tr>
                    <td class="style6">
                        &nbsp;</td>
                    <td align="center">
                        <asp:Label ID="Avtentikacija" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="style6">
