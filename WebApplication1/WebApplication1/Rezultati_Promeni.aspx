<%@ Page Title="Промени Резултат" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rezultati_Promeni.aspx.cs" Inherits="WebApplication1.Rezultati_Promeni" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="accordion">
        <h3>ПРОМЕНИ ПОДАТОЦИ Зa Резултати</h3>
            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        Тука извршете промена на податоците за Rezultati 
                    </td>
                </tr>
                <tr>
                    <td class="style5">
                    ...
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="rezultat_id" SortExpression="rezultat_id">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("rezultat_id") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("rezultat_id") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
     ...
     <asp:Label ID="Notify_nadvor" runat="server" ForeColor="#FF3300" Text=""></asp:Label>
</asp:Content>
