<%@ Page Title="Клуб Избриши" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Klubovi_Izbrishi.aspx.cs" Inherits="WebApplication1.Klubovi_Izbrishi" %>
...
<div id="accordion">
        <h3>ИЗБРИШИ ПОДАТОЦИ ЗА КЛУБОВИ</h3>
            ...
            <table class="style1">
                ...
                <tr>
                    <td class="style7" colspan="2" align="center">
                        Тука можете да ги Избришете податоците за Клубовите
                    </td>
                </tr>
                <tr>
        ...
        <table class="style1">
            <tr>
                <td class="style6" align="center">
                        <asp:Label ID="Klub_Izbrishi_notify" runat="server" Text=""></asp:Label>
                    </td>
            </tr>
            <tr>
                <td class="style6" align="center">
                    <asp:Label ID="Klubovi_Notify_nadvor" runat="server" ForeColor="#FF3300"></asp:Label>
                </td>
            </tr>
        </table>
