<%@ Page Title="Резултат членови турнир" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rezultat_Clenovi.aspx.cs" Inherits="WebApplication1.Rezultat_Clenovi" %>
...
<div id="accordion">
        <h3>
            Приказ на Член според Резултат на Турнир</h3>
        <div class="style">
