<%@ Page Title="Резултат за Клуб" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rezultat_Klubovi.aspx.cs" Inherits="WebApplication1.Rezultat_Klubovi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="accordion">
        <h3>
            Приказ на Клубови според резултат на Турнир</h3>
        <div class="style">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownList1_IdKlub" runat="server" AutoPostBack="True" AppendDataBoundItems="true"
                            ...
                            onselectedindexchanged="DropDownList1_IdKlub_SelectedIndexChanged1">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ControlToValidate="DropDownList1_IdKlub" ErrorMessage="Задолжително Поле"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                            ControlToValidate="DropDownList2_Id_Turnir" 
